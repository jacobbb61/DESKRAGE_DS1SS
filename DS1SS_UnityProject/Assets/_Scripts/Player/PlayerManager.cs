...
public class PlayerManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (SceneManager.GetActiveScene().name == "Build" || SceneManager.GetActiveScene() == SceneManager.GetSceneByName("Build Nightmare"))
        {
    ...
    private void Update()
    {
        if (SceneManager.GetActiveScene() == SceneManager.GetSceneByName("Build") || SceneManager.GetActiveScene() == SceneManager.GetSceneByName("Build Nightmare")) { TimePlayedSeconds += Time.deltaTime; }
    }
    ...
    public void SaveGameDataToCurrentCharacterData(ref CharacterSaveData CurrentCharacterData)
    {
        ...
        {
            CurrentCharacterData.Nightmare = false;
        }
        ...
        CurrentCharacterData.NKey = NKey;
        ...
        CurrentCharacterData.DemonDeaths = DemonArena.DemonDeaths;
    ...
    public void LoadGameFromDataToCurrentCharacterData(ref CharacterSaveData CurrentCharacterData)
    {
        ...
        NKey = CurrentCharacterData.NKey;
        ...
        if (DemonArena != null) { DemonArena.currentState = CurrentCharacterData.DemonArenaState; DemonArena.DemonDeaths = CurrentCharacterData.DemonDeaths; DemonArena.ManualStart(); }
