...
public class AsylumDemon : MonoBehaviour
{
    ...
    public void RH_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(RH_AttackDamage + 10, true, 0); }
            else
            {
    ...
    public void RH_AOE_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(RH_AttackDamage_AOE + 10, true, 0); }
            else
            {
                PC.PlayerTakeDamage(RH_AttackDamage_AOE, true, 0);
            }
        }
    }
    ...
    public void LH_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(LH_AttackDamage + 10, true, 0); }
            else
            {
    ...
    public void GP_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(GP_AttackDamage + 10, true, 0); }
            else
            {
    ...
    public void HBS_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(HBS_AttackDamage + 10, true, 0); }
            else
            {
    ...
    public void HFS_AttackRegister()
    {
        ...
        {
            if (Nightmare) { PC.PlayerTakeDamage(HFS_AttackDamage + 10, true, 0); } else
            {
